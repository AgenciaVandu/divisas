                        ...
                        <div class="tab-pane fade" id="pills-altabrisa" role="tabpanel" aria-labelledby="pills-altabrisa-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6 inf-sucursal m-auto">
                                    ...
                                    <div class="text-right">
                                        <p style="color:rgb(100, 100, 100);">PLAZA ALTABRISA, KIOSKO 7, PLANTA BAJA CALLE 7 Nº 451 X 22 Y 24 FRACC. ALTABRISA. MÉRIDA, YUCATÁN. CP 97133</p>
                                        <p>
                                           <div class="row pt-3">
                                            <div class="col-md-4 col-sm-12">
                                                <span class="tel">TEL</span><br>
                        ...
                        <div class="tab-pane fade" id="pills-fiesta" role="tabpanel" aria-labelledby="pills-fiesta-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6 inf-sucursal m-auto">
                                    ...
                                    <div class="text-right">
                                        <p style="color:rgb(100, 100, 100);">PLAZA FIESTA, LOCAL 54. CALLE 6 Nº 400 X 21 COL. DÍAZ ORDAZ, MÉRIDA, YUCATÁN. C.P. 97130.</p>
                                        <p>
                                           <div class="row pt-3">
                                            <div class="col-md-4 col-sm-12">
                                                <span class="tel">TEL</span><br>
                        ...
                        <div class="tab-pane fade" id="pills-colon" role="tabpanel" aria-labelledby="pills-colon-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6 inf-sucursal m-auto">
                                    ...
                                    <div class="text-right">
                                        <p style="color:rgb(100, 100, 100);">CALLE 62 NO. 483 DEPTO "G" BAJOS "HOTEL COLÓN" ENTRE CALLE 57 Y 59 COL. CENTRO C.P. 97000. MÉRIDA, YUCATÁN, MÉXICO</p>
                                        <p>
                                           <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                                <span class="tel">TEL</span><br>
                        ...
                        <div class="tab-pane fade" id="pills-centro" role="tabpanel" aria-labelledby="pills-centro-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6 inf-sucursal m-auto">
                                    ...
                                    <div class="text-right">
                                        <p style="color:rgb(100, 100, 100);">CALLE 59 NO. 509 DEPTO 1 ENTRE 60 Y 62 COL. CENTRO C.P. 97000 MÉRIDA, YUCATÁN, MÉXICO</p>
                                        <p>
                                           <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                                <span class="tel">TEL</span><br>
                        ...
                        <div class="tab-pane fade" id="pills-mexico" role="tabpanel" aria-labelledby="pills-mexico-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6 inf-sucursal m-auto">
                                    ...
                                    <div class="text-right">
                                        <p style="color:rgb(100, 100, 100);">AVENIDA DÍAZ BOLIO N° 196 LOCAL "A" CALLE 21 X 14 COL MÉXICO ORIENTE C.P. 97137</p>
                                        <p>
                                           <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                                <span class="tel">TEL</span><br>
